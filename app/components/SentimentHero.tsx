...
export default function SentimentHero({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl p-12 bg-[#0a1420] border border-white/10">
      {/* Centered Content */}
      <div className="flex flex-col items-center justify-center text-center">
        {/* Animal Icon - Large Emoji */}
        <div className="mb-4 text-[140px] leading-none" style={{ filter: `drop-shadow(0 0 60px ${glowRgba}) drop-shadow(0 0 30px ${glowRgba})` }}>
          {isBullish ? '🐂' : isBearish ? '🐻' : '😐'}
        </div>
