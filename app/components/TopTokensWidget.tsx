        ...
        {tokens.length === 0 ? (
          ...
          tokens.map((token, index) => (
            <div
              ...
              className="flex items-center justify-between p-2 rounded-lg bg-[#061019] hover:bg-[#0d1a2a] transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-[#00ffa7]/10 group cursor-pointer"
